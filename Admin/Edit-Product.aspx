<%@ Page Title="Edit Product Detail" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Edit-Product.aspx.cs" Inherits="Add_Branch" %>
    ...
    <div class="page-wrapper" style="min-height: 568px;">
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <h3 class="page-title">Edit Product Detail</h3>
                    </div>
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <label class="col-form-label">
                                        Product Name<asp:RequiredFieldValidator ID="rqtxtlast" Font-Size="9" runat="server" ControlToValidate="txtlast" Text="*" ForeColor="Red" Display="Dynamic" ErrorMessage="Enter Pendency">
                                        </asp:RequiredFieldValidator></label>
