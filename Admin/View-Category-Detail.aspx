<%@ Page Title="View Category Detail" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="View-Category-Detail.aspx.cs" Inherits="Departments" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">View Category Detail</h3>
                    </div>
                     <div class="col-auto float-end ms-auto">
                        <asp:HyperLink class="btn add-btn" Text="Add Category Detail" NavigateUrl="Add-Category .aspx" runat="server"></asp:HyperLink>
                    </div>
                </div>
            </div>
            <div id="table-datatables" class="table-responsive">
                <asp:GridView ID="gvv" runat="server" class="table table-nowrap mb-0" EmptyDataText="No records found"  AutoGenerateColumns="false">
                    <Columns>
                        <asp:BoundField DataField="Category ID" HeaderText="Category ID" SortExpression="Category ID" />
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $.ajax({
                type: "POST",
                url: "View-Category-Detail.aspx/GetData",
                beforeSend: function () {
                },
            ...
            $("[id*=gvv]").DataTable(
                {
                    ...
                    columns: [
                        ...
                        },                       
                        {
                            data: 'id',
                            name: 'id',
                            render: function (data, type, row, meta) { return '<a class="d-inline-block fw-normal w-100 h-100 pe-auto" href="Edit-Category.aspx?id=' + row.id + '">Edit</a>'; },
                        },
                       
                        {
                            data: 'id',
                            name: 'id',
                            render: function (data, type, row, meta) { return '<a class="d-inline-block fw-normal w-100 h-100 pe-auto" href="View-Category-Detail.aspx?action=delete&id=' + row.id + '">Delete</a>'; },
                        }
                      ]
                });
        };
