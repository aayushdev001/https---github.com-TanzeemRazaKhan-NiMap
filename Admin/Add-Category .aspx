<%@ Page Title="Add Category" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Add-Category .aspx.cs" Inherits="Add_Branch" %>
                        ...
                        <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <asp:TextBox ID="txtfirst" class="form-control" Placeholder="Category ID" runat="server"></asp:TextBox>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <asp:TextBox ID="txtlast" class="form-control" Placeholder="Category Name" runat="server"></asp:TextBox>
