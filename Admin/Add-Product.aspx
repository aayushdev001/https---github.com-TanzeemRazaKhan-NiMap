<%@ Page Title="Add Product" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Add-Product.aspx.cs" Inherits="Add_Branch" %>
            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-auto float-end ms-auto">
                        <asp:HyperLink class="btn add-btn" Text="View Product Detail" NavigateUrl="View-Product-Detail.aspx" runat="server"></asp:HyperLink>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <label class="col-form-label">
                                        Product ID<asp:RequiredFieldValidator ID="rqtxtfirst" Font-Size="9" runat="server" ControlToValidate="txtfirst" Text="*" ForeColor="Red" Display="Dynamic" ErrorMessage="Enter Pendency">
                                        </asp:RequiredFieldValidator></label>
                                    <asp:TextBox ID="txtfirst" class="form-control" Placeholder="Product ID" runat="server"></asp:TextBox>
                                ...
                                <div class="col-lg-4">
                                    <label class="col-form-label">
                                        Product Name<asp:RequiredFieldValidator ID="rqtxtlast" Font-Size="9" runat="server" Placeholder="Product Name" ControlToValidate="txtlast" Text="*" ForeColor="Red" Display="Dynamic" ErrorMessage="Enter Pendency">
                                        </asp:RequiredFieldValidator></label>
                                    <asp:TextBox ID="txtlast" class="form-control" Placeholder="Product Name" runat="server"></asp:TextBox>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <asp:DropDownList ID="ddlcategory"  AppendDataBoundItems="true" AutoPostBack="true" class="form-control form-select" runat="server">
